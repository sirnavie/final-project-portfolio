...
var die1, die2, dieSum, balance, banner, outcome, die1Name, die2Name, numRolls, count; // define variables
...
function onLoad() {
  count = prompt("How many times do you want to play?");
  console.log(count);
}
